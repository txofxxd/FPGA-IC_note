...
总结来说：Vivado 2018.3 的仿真器 XSIM 依赖 Ubuntu 老版本的系统库（libncurses5 / libtinfo5），而 Ubuntu 22.04 默认没有这些库，导致 elaboration 阶段生成的 C 程序无法运行，从而报出看似“编译失败”的 XSIM 43-3409 错误。hh
